    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header-v2">
          <h1 class="title">Создание услуги</h1>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="custom-arrow" v-model="data.type">
                  <option value="1">Трансфер</option>
                  <option value="2">Экскурсия</option>
                  <option value="3">Тур</option>
                </select>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    create: function () {
      this.$store.dispatch('createService', this.data).then((res) => {
    ...
    close: function () {
      this.$root.$emit('triggerModal', {name: 'createServiceModal'})
    }
  }
}
</script>
